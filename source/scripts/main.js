!
        ...
        var r = {
            backTop: function (t) {
                ...
                var e = setInterval(function () {
                    ...
                    window.scrollTo(0, Math.max(Math.floor(.8 * t))),
                        0 === t && clearInterval(e)
                },
                    20)
            },
    ...
    function (t, e, n) {
        ...
        var u = "color: #fff; background: #f75357; padding: 1px; border-radius: 5px;";
        console.info("%c 🎯 hexo-theme-archer ⬇️ ", u),
            console.info("%c 🏷 Version: 1.5.1 ", u),
            console.info("%c 📅 Version date: 20180721", u),
            console.info("%c 📦 https://github.com/fi3ework/hexo-theme-archer ", u),
            (0, r.
                default)(),
            (0, i.scroll)();
        var h = new s.
    ...
    function (t, e, n) {
        ...
        var o = function () {
            ...
            if (n.length < 2) return console.log("..."),
                void console.log(n);
            var r = n[1],
                o = new Image;
            o.onload = function () {
                    ...
                    return function (t) {
                        ...
                        this.options = t || {},
                            ...
                            this.add = function (t) {
                                ...
                                }(), i = document.querySelectorAll("[id]"), o = [].map.call(i,
                                    function (t) {
                                        return t.id
                                    }), a = 0; a < r.length; a++) if (this.hasAnchorJSLink(r[a])) A.push(a);
                                    else {
                                        if (r[a].hasAttribute("id")) s = r[a].getAttribute("id");
                                        else if (r[a].hasAttribute("data-anchor-id")) s = r[a].getAttribute("data-anchor-id");
                                        else {
                                            h = u = this.urlify(r[a].textContent),
                                                c = 0;
                                            do {
                                            ...
                                            l = void 0,
                                                o.push(h),
                                                r[a].setAttribute("id", h),
                                                s = h
                                        }
                                        s.replace(/-/g, " "),
                                            (f = document.createElement("a")).className = "anchorjs-link " + this.options.class,
                                            f.href = "#" + s,
                                            f.setAttribute("aria-label", this.options.ariaLabel),
                                            f.setAttribute("data-anchorjs-icon", this.options.icon),
                                            "always" === d && (f.style.opacity = "1"),
                                            "" === this.options.icon && (f.style.font = "1em/1 anchorjs-icons", "left" === this.options.placement && (f.style.lineHeight = "inherit")),
                                            "left" === this.options.placement ? (f.style.position = "absolute", f.style.marginLeft = "-1em", f.style.paddingRight = "0.5em", r[a].insertBefore(f, r[a].firstChild)) : (f.style.paddingLeft = "0.375em", r[a].appendChild(f))
                                    }
                                for (a = 0; a < A.length; a++) r.splice(A[a] - a, 1);
                                return this.elements = this.elements.concat(r),
                                    this
                            },
                            ...
                            this.urlify = function (t) {
                                return this.options.truncate || e(this.options),
                                    t.trim().replace(/\'/gi, "").replace(/[& +$,:;=?@"#{}|^~[`%!'<>\]\.\/\(\)\*\\]/g, "-").replace(/-{2,}/g, "-").substring(0, this.options.truncate).replace(/^-+|-+$/gm, "").toLowerCase()
                            },
            ...
            function p(t) {
                if (t > a) {
                    if (1 !== d) return d = 1,
                        A = !1,
                        1
                } else if (- 1 !== d) return d = -1,
                    A = !0,
                    -1;
                return 0
            }
            var v, b, g = !1;
            $(".post-body").length && (g = !0, b = a, v = $(".article-entry").outerHeight(), v = $(".container")[0].addEventListener("transitionend",
                function () {
    ...
    function (t, e, n) {
        ...
        function c(t, e) {
            return Array.prototype.filter.call(t.children,
                function (t) {
                    return a(t, e)
                })
        }
        ...
        v.prototype.eventElement = function (t) {
            ...
            return e || (e = new A(t), this.eventElements.push(e)),
                e
        },
        ...
        var g = function (t, e, n, r, i) {
            ...
            if (void 0 === r && (r = !0), void 0 === i && (i = !1), "top" === e) o = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"];
                ...
                function (t, e, n, r, i) {
                    ...
                    var h = t.element;
                    t.reach[l] = null,
                        h[a] < 1 && (t.reach[l] = "start");
                    h[a] > t[o] - t[s] - 1 && (t.reach[l] = "end");
                    e && (h.dispatchEvent(b("ps-scroll-" + l)), e < 0 ? h.dispatchEvent(b("ps-scroll-" + c)) : e > 0 && h.dispatchEvent(b("ps-scroll-" + u)), r &&
                        function (t, e) {
                            f(t, e),
                                d(t, e)
                        }(t, l));
        ...
        var y = {
            ...
            w = function (t) {
                ...
                t.containerWidth = e.clientWidth,
                    ...
                    e.contains(t.scrollbarXRail) || (c(e, u.element.rail("x")).forEach(function (t) {
                        return l(t)
                    }), e.appendChild(t.scrollbarXRail)),
                    e.contains(t.scrollbarYRail) || (c(e, u.element.rail("y")).forEach(function (t) {
                        return l(t)
                    }), e.appendChild(t.scrollbarYRail)),
                    !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? (t.scrollbarXActive = !0, t.railXWidth = t.containerWidth - t.railXMarginWidth, t.railXRatio = t.containerWidth / t.railXWidth, t.scrollbarXWidth = E(t, m(t.railXWidth * t.containerWidth / t.contentWidth)), t.scrollbarXLeft = m((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1,
                    ...
                    t.scrollbarXActive ? e.classList.add(u.state.active("x")) : (e.classList.remove(u.state.active("x")), t.scrollbarXWidth = 0, t.scrollbarXLeft = 0, e.scrollLeft = 0),
                    t.scrollbarYActive ? e.classList.add(u.state.active("y")) : (e.classList.remove(u.state.active("y")), t.scrollbarYHeight = 0, t.scrollbarYTop = 0, e.scrollTop = 0)
            };
        function E(t, e) {
        ...
        function C(t, e) {
            ...
            function b() {
                d(t, c),
                    t.event.unbind(t.ownerDocument, "mousemove", v)
            }
            t.event.bind(t[s], "mousedown",
                function (e) {
                    h = u[l],
                        A = e[i],
                        p = (t[r] - t[n]) / (t[o] - t[a]),
                        t.event.bind(t.ownerDocument, "mousemove", v),
        ...
        var L = {
            "click-rail": function (t) {
                t.event.bind(t.scrollbarY, "mousedown",
                    ...
                    t.event.bind(t.scrollbarYRail, "mousedown",
                        function (e) {
                    ...
                    t.event.bind(t.scrollbarXRail, "mousedown",
                        function (e) {
            ...
            "drag-thumb": function (t) {
                C(t, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "x"]),
                    C(t, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight", "scrollTop", "y"])
            },
            keyboard: function (t) {
                var e = t.element;
                t.event.bind(t.ownerDocument, "keydown",
                    function (n) {
                        if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (a(e, ":hover") || a(t.scrollbarX, ":focus") || a(t.scrollbarY, ":focus"))) {
                            ...
                            t.settings.suppressScrollX && 0 !== o || t.settings.suppressScrollY && 0 !== s || (e.scrollTop -= s, e.scrollLeft += o, w(t),
                                function (n, r) {
                                    var i = e.scrollTop;
                                    if (0 === n) {
            ...
            wheel: function (t) {
                ...
                function n(n) {
                    ...
                    if (!
                        ...
                        var a = !1;
                        t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (s ? e.scrollTop -= s * t.settings.wheelSpeed : e.scrollTop += o * t.settings.wheelSpeed, a = !0) : t.scrollbarXActive && !t.scrollbarYActive && (o ? e.scrollLeft += o * t.settings.wheelSpeed : e.scrollLeft -= s * t.settings.wheelSpeed, a = !0) : (e.scrollTop -= s * t.settings.wheelSpeed, e.scrollLeft += o * t.settings.wheelSpeed),
                            w(t),
                            (a = a ||
                                function (n, r) {
                                    var i = 0 === e.scrollTop,
            ...
            Y = function (t, e) {
                ...
                for (var s in this.element = t,
                    t.classList.add(u.main), this.settings = {
                ...
                this.isRtl = "rtl" === r(t).direction,
                    this.isNegativeScroll = (l = t.scrollLeft, t.scrollLeft = -1, a = t.scrollLeft < 0, t.scrollLeft = l, a),
                ...
                this.scrollbarXBottom = parseInt(f.bottom, 10),
                    isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = m(f.top)) : this.isScrollbarXUsingBottom = !0,
                    this.railBorderXWidth = m(f.borderLeftWidth) + m(f.borderRightWidth),
                    i(this.scrollbarXRail, {
                        display: "block"
                    }),
                    this.railXMarginWidth = m(f.marginLeft) + m(f.marginRight),
                    i(this.scrollbarXRail, {
                        display: ""
                    }),
                ...
                this.scrollbarYRight = parseInt(d.right, 10),
                    isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !1, this.scrollbarYLeft = m(d.left)) : this.isScrollbarYUsingRight = !0,
                    this.scrollbarYOuterWidth = this.isRtl ?
                        function (t) {
                            var e = r(t);
                            return m(e.width) + m(e.paddingLeft) + m(e.paddingRight) + m(e.borderLeftWidth) + m(e.borderRightWidth)
                        }(this.scrollbarY) : null,
                    this.railBorderYWidth = m(d.borderTopWidth) + m(d.borderBottomWidth),
                    i(this.scrollbarYRail, {
                        display: "block"
                    }),
                    this.railYMarginHeight = m(d.marginTop) + m(d.marginBottom),
                    i(this.scrollbarYRail, {
                        display: ""
                    }),
        ...
        var f = function () {
            function t(e, n, r) {
                c(this, t),
                    ...
                    this.postsArr = null,
                    this.metaName = e,
                    this.labelsContainer = $(n)[0],
                    this.postContainer = $(r)[0],
            ...
            },
            {
                ...
                value: function () {
                    var t = this;
                    this.labelsContainer.addEventListener("click",
                        function (e) {
            ...
            },
            {
                key: "_createPostDom",
                value: function (t) {
                    var e = $('<li class="meta-post-item"><span class="meta-post-date">' + r.
                        default.dateFormater(new Date(Date.parse(t.date)), "yyyy/MM/dd") + "</span></li>"),
            ...
            },
            {
                ...
                value: function (t) {
                    ...
                    if (!this.isInited && "[object Null]" !== Object.prototype.toString.call(t)) {
                        ...
                        this.indexMap.size || document.getElementsByClassName("sidebar-".concat(this.metaName, "-empty"))[0].classList.add("sidebar-".concat(this.metaName, "-empty-active")),
                            this.postsArr = t,
                            this.isInited = !0
                    }
                }
                        ...
                        document.body.addEventListener("click",
                            function (e) {
                                if ("post-tag" === e.target.className) {
                                    e.stopPropagation(),
                                        i.
                                            default.activateSidebar(),
                                        i.
                                            default.switchTo(1);
                                    var n = e.target.getAttribute("data-tags");
                                    t.currLabelName = n,
                                        t.metas[0].changeLabel(t.currLabelName)
                                }
                            })
                    }
                }]),
    ...
    function (t, e, n) {
        ...
        function s(t, e, n, r, o) {
            ...
            var s = new
                ...
                a = i ? i + e : e;
            return t._events[a] ? t._events[a].fn ? t._events[a] = [t._events[a], s] : t._events[a].push(s) : (t._events[a] = s, t._eventsCount++),
                t
        }
        function a(t, e) {
        ...
        Object.create && (o.prototype = Object.create(null), (new o).__proto__ || (i = !1)),
            ...
            l.prototype.listeners = function (t) {
                ...
                for (var r = 0,
                    o = n.length,
                    s = new Array(o); r < o; r++) s[r] = n[r].fn;
                return s
            },
                    ...
                    switch (u.once && this.removeListener(t, u.fn, void 0, !0), h) {
                        ...
                        case 3:
                            return u.fn.call(u.context, e, n),
                                !0;
                        case 4:
                            return u.fn.call(u.context, e, n, r),
                                !0;
                        case 5:
                            return u.fn.call(u.context, e, n, r, o),
                                !0;
                        case 6:
                            return u.fn.call(u.context, e, n, r, o, s),
                                !0
                    }
            ...
            l.prototype.removeListener = function (t, e, n, r) {
                ...
                if (!e) return a(this, o),
                    this;
                var s = this._events[o];
                if (s.fn) s.fn !== e || r && !s.once || n && s.context !== n || a(this, o);
                else {
                    for (var l = 0,
                        c = [], u = s.length; l < u; l++)(s[l].fn !== e || r && !s[l].once || n && s[l].context !== n) && c.push(s[l]);
            ...
            l.prototype.removeAllListeners = function (t) {
                var e;
                return t ? (e = i ? i + t : t, this._events[e] && a(this, e)) : (this._events = new o, this._eventsCount = 0),
                    this
            },
        ...
        (function (t, r) {
            ...
            function a(t, n) {
                ...
                return arguments.length >= 3 && (r.depth = arguments[2]),
                    ...
                    A(n) ? r.showHidden = n : n && e._extend(r, n),
            ...
            function u(t, n, r) {
                ...
                var c, y = "",
                    L = !1,
                    Y = ["{", "}"]; (d(n) && (L = !0, Y = ["[", "]"]), C(n)) && (y = " [Function" + (n.name ? ": " + n.name : "") + "]");
                return m(n) && (y = " " + RegExp.prototype.toString.call(n)),
                    w(n) && (y = " " + Date.prototype.toUTCString.call(n)),
                    E(n) && (y = " " + h(n)),
                    0 !== s.length || L && 0 != n.length ? r < 0 ? m(n) ? t.stylize(RegExp.prototype.toString.call(n), "regexp") : t.stylize("[Object]", "special") : (t.seen.push(n), c = L ?
                        function (t, e, n, r, i) {
            ...
            function f(t, e, n, r, i, o) {
                ...
                if ((l = Object.getOwnPropertyDescriptor(e, i) || {
                    ...
                    if (o && i.match(/^\d+$/)) return a; (s = JSON.stringify("" + i)).match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/) ? (s = s.substr(1, s.length - 2), s = t.stylize(s, "name")) : (s = s.replace(/'/g, "\\'").replace(/\\"/g, '"').replace(/(^"|"$)/g, "'"), s = t.stylize(s, "string"))
                }
                return s + ": " + a
            }
            function d(t) {
            ...
            e.debuglog = function (t) {
                if (g(o) && (o = r.env.NODE_DEBUG || ""), t = t.toUpperCase(), !s[t]) if (new RegExp("\\b" + t + "\\b", "i").test(o)) {
                    var n = r.pid;
                    s[t] = function () {
    ...
    function (t, e, n) {
        ...
        var s = 0;
        var a = function (t, e) {
            for (var n = 0; n < t.length; n++) if (Math.abs(e - t[n]) < 1.1) return n;
            return - 1
        },
            l = function (t, e, n) {
                    ...
                    function () {
                        var n = $(document).scrollTop(),
                            i = function (t, e, n) {
                                var r = a(t, n);
                                if (r >= 0) return r;
                                for (var i = 0; i < t.length; i++) if (l(n, e, t[i])) return n > e ? i : i - 1
                            }(r, s, n);
                        if (s = n, void 0 !== i) {
                            var o = e[i]; !
                                function (t) {
                                ...
                                o && o.querySelector("a").classList.add("toc-active")
                        }
                    })
            }
        };
    ...
    function (t, e, n) {
        ...
        e.
            default = function () {
                document.querySelectorAll(".article-entry img").forEach(function (t) {
                    var e = t.outerHTML,
                        n = /src="(.*)"/.exec(e) && /src="(.*)"/.exec(e)[1],
                        r = /alt="(.*)"/.exec(e) && /alt="(.*)"/.exec(e)[1];
